...
export function Footer() {
  ...
  useGsap(() => {
    ...
    // Animate intro and questions, but keep actions simple for visibility debug
    gsap.from(q(".footer-intro, .question-item"), {
      opacity: 0,
      y: 30,
      stagger: 0.1,
      duration: 1,
      ...
      <Container>
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 mb-24">
          <div className="lg:col-span-7">
            <div className="footer-intro mb-12">
              <h3 className="text-primary font-bold tracking-widest text-sm uppercase mb-4">💬 Victory Audit</h3>
              <h4 className="text-3xl md:text-4xl font-serif font-bold mb-4">Reflection Yard</h4>
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div className="question-item">
              ...
              <p className="text-3xl font-serif italic mb-12">Accountability is forged in community.</p>
              ...
              <div className="flex flex-col gap-8">
                <a
                  ...
                  className="opacity-80 hover:opacity-100 transition-opacity self-start"
                >
                  <img
